...
$gol = query("SELECT * FROM golongan WHERE id_golongan = $id")[0];

// cek tombol submit sdh ditekan atau belum
if (isset($_POST["submit"])) {
	// cek apakah data berhasil di ubah atau tidak
	if (ubah_golongan($_POST) > 0) {
		echo "
				<script>
		...
		<form method="POST" action="">
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					required value="<?php echo $gol["nama_golongan"]; ?>">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					required value="<?php echo $gol["gaji_pokok"]; ?>">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					required value="<?php echo $gol["tunjangan_transportasi"]; ?>">
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					required value="<?php echo $gol["tunjangan_makan"]; ?>">
				</div>
			</div>
			<div>
